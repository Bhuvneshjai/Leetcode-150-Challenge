'''
Text Justification: Given an array of strings words and a width maxWidth, format the text such that each line has
    ...
    def fullJustify(self, words: list[str], maxWidth: int) -> list[str]:
        ...
        for word in words:
            ...
            if line_length + len(word) + len(line) > maxWidth:
                # Add spaces between words to justify the line
        ...
        # Last line: left-justify (add spaces at the end)
