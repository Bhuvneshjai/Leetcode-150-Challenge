...
class RandomizedSet:
    ...
    def remove(self, val: int) -> bool:
        ...
        self.values[idx_to_replace] = last_val
        self.val_to_index[last_val] = idx_to_replace
