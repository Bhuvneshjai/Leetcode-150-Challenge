'''
Merge Sorted Array: You are given two integer arrays nums1 and nums2, sorted in non-decreasing order,
...
class Solution:
    ...
    def merge2(self, nums1: list[int], m, nums2: list[int], n) -> None:
        nums1[:] = sorted(nums1[:m] + nums2)

    def merge3(self, nums1: list[int], m, nums2: list[int], n) -> None:
        p1 = m-1
        p2 = n-1
        p = m+n-1
